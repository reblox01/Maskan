...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-slate-200 px-3 text-sm font-medium ring-offset-white transition-colors hover:bg-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-red-100/40 group-[.destructive]:hover:bg-red-100 group-[.destructive]:hover:border-red-100/40 group-[.destructive]:focus:ring-red-500 group-[.destructive]:focus:ring-offset-red-500",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-slate-500 opacity-0 transition-opacity hover:text-slate-900 focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:text-red-50 group-[.destructive]:focus:ring-red-400 cursor-pointer",
      className
    )}
    toast-close=""
    {...props}
